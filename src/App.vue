          ...
          <div class="tab-pane fade show active text-center" role="tabpanel" id="search" aria-labelledby="search-tab">
            <div class="input-group input-group-sm search">
              ...
              <div class="input-group-append">
                <button @click="getDetails" class="btn btn-success">Search</button>
              </div>
            </div>
            <template v-if="myPokemon !== null">
              <button class="btn btn-success btn-sm"
                      @click="addToTeam(myPokemon)">Save to Team</button>
              <pokemonDetails :pokemon="myPokemon" />
            </template>
          </div>
          <div v-for="pokemon in pokemonTeam" 
    ...
    methods: {
      async getDetails() {
        try {
          ...
          this.myPokemon = {details, typing: this.calculateTyping(typing)};
        } catch (e) {
          console.error(e);
        }
      },
